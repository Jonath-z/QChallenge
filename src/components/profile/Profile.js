    ...
    return (
        <div className='profile-container'>
            ...
            >
                ...
                {
                    props.userScore !== undefined && props.userScore.map((score, index) => {
                        return (
                            <div className='user-profile-details' key={index}>
                                <ul className='user-profile-details-ul'>
                                    ...
                                    <li className='user-profile-details-li'>Score: {score.score}</li>
                                    <li className='user-profile-details-li'>Questions: {score.level}</li>
                                </ul>
                            </div>
                        )
                    })
